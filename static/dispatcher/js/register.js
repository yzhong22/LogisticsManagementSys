            ...
            this.$refs[form].validate((valid) => {
                if (valid) {
                    let data = {
                        ...
                        phoneNum: this.register_form.phoneNum
                    };
                    axios.post('/api/dispatcher/register', data)
                        .then(response => {
                            if (response.data.ifExist == false) {
                                ...
                                window.setTimeout("window.location='/dispatcher/login'", 2000);
